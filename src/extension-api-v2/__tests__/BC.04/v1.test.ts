...
describe('BC.04 — Node interaction: pointer, selection, resize [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N10', 0) and run against runV1().
  it.todo('S2.N10 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N17', 0) and run against runV1().
  it.todo('S2.N17 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N19', 0) and run against runV1().
  it.todo('S2.N19 — exemplar contract on v1')
})
