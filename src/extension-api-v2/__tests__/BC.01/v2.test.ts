...
describe('BC.01 — Node lifecycle: creation [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N1', 0) and run against runV2().
  it.todo('S2.N1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N8', 0) and run against runV2().
  it.todo('S2.N8 — exemplar contract on v2')
})
