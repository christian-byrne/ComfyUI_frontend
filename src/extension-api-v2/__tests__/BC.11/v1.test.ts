...
describe('BC.11 — Widget imperative state writes [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W4', 0) and run against runV1().
  it.todo('S4.W4 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W5', 0) and run against runV1().
  it.todo('S4.W5 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N16', 0) and run against runV1().
  it.todo('S2.N16 — exemplar contract on v1')
})
