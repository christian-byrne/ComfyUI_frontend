...
describe('BC.09 — Dynamic slot and output mutation [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S10.D1', 0) and run against runV2().
  it.todo('S10.D1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S10.D3', 0) and run against runV2().
  it.todo('S10.D3 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S15.OS1', 0) and run against runV2().
  it.todo('S15.OS1 — exemplar contract on v2')
})
