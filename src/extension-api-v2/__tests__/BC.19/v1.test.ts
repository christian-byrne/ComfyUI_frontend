...
describe('BC.19 — Workflow execution trigger [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A4', 0) and run against runV1().
  it.todo('S6.A4 — exemplar contract on v1')
})
