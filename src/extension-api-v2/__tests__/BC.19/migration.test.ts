...
describe('BC.19 — Workflow execution trigger [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A4', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S6.A4 — migrates from v1 to v2')
})
