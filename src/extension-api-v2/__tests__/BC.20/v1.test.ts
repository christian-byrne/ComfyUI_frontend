...
describe('BC.20 — Custom node-type registration (frontend-only / virtual) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H5', 0) and run against runV1().
  it.todo('S1.H5 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H6', 0) and run against runV1().
  it.todo('S1.H6 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S8.P1', 0) and run against runV1().
  it.todo('S8.P1 — exemplar contract on v1')
})
