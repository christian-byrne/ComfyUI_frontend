...
describe('BC.20 — Custom node-type registration (frontend-only / virtual) [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H5', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S1.H5 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H6', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S1.H6 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S8.P1', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S8.P1 — migrates from v1 to v2')
})
