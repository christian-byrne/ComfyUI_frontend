...
describe('BC.30 — Graph change tracking, batching, and reactivity flush [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S11.G1', 0) and run against runV2().
  it.todo('S11.G1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S11.G3', 0) and run against runV2().
  it.todo('S11.G3 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S11.G4', 0) and run against runV2().
  it.todo('S11.G4 — exemplar contract on v2')
})
