...
describe('BC.26 — Globals as ABI (window.LiteGraph, window.comfyAPI) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S7.G1', 0) and run against runV1().
  it.todo('S7.G1 — exemplar contract on v1')
})
