...
describe('BC.10 — Widget value subscription [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W1', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S4.W1 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N14', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N14 — migrates from v1 to v2')
})
