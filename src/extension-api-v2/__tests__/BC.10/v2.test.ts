...
describe('BC.10 — Widget value subscription [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W1', 0) and run against runV2().
  it.todo('S4.W1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N14', 0) and run against runV2().
  it.todo('S2.N14 — exemplar contract on v2')
})
