...
describe('BC.13 — Per-node serialization interception [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N6', 0) and run against runV1().
  it.todo('S2.N6 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N15', 0) and run against runV1().
  it.todo('S2.N15 — exemplar contract on v1')
})
