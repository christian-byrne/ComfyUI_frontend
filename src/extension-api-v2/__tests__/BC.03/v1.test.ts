...
describe('BC.03 — Node lifecycle: hydration from saved workflows [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H1', 0) and run against runV1().
  it.todo('S1.H1 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N7', 0) and run against runV1().
  it.todo('S2.N7 — exemplar contract on v1')
})
