...
describe('BC.03 — Node lifecycle: hydration from saved workflows [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H1', 0) and run against runV2().
  it.todo('S1.H1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N7', 0) and run against runV2().
  it.todo('S2.N7 — exemplar contract on v2')
})
