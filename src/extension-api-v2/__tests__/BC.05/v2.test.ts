...
describe('BC.05 — Custom DOM widgets and node sizing [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W2', 0) and run against runV2().
  it.todo('S4.W2 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N11', 0) and run against runV2().
  it.todo('S2.N11 — exemplar contract on v2')
})
