...
describe('BC.21 — Custom widget-type registration [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H2', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S1.H2 — migrates from v1 to v2')
})
