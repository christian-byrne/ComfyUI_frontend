...
describe('BC.21 — Custom widget-type registration [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H2', 0) and run against runV1().
  it.todo('S1.H2 — exemplar contract on v1')
})
