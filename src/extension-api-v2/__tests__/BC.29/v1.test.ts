...
describe('BC.29 — Graph enumeration, mutation, and cross-scope identity [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S11.G2', 0) and run against runV1().
  it.todo('S11.G2 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S14.ID1', 0) and run against runV1().
  it.todo('S14.ID1 — exemplar contract on v1')
})
