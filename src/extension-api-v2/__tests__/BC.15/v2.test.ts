...
describe('BC.15 — Workflow loading into the editor [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A2', 0) and run against runV2().
  it.todo('S6.A2 — exemplar contract on v2')
})
