...
describe('BC.15 — Workflow loading into the editor [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A2', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S6.A2 — migrates from v1 to v2')
})
