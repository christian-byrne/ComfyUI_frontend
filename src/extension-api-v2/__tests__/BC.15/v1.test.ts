...
describe('BC.15 — Workflow loading into the editor [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A2', 0) and run against runV1().
  it.todo('S6.A2 — exemplar contract on v1')
})
