...
describe('BC.12 — Per-widget serialization transform [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W3', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S4.W3 — migrates from v1 to v2')
})
