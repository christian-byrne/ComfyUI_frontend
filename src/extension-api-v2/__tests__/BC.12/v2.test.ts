...
describe('BC.12 — Per-widget serialization transform [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W3', 0) and run against runV2().
  it.todo('S4.W3 — exemplar contract on v2')
})
