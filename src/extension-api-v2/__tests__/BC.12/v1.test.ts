...
describe('BC.12 — Per-widget serialization transform [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S4.W3', 0) and run against runV1().
  it.todo('S4.W3 — exemplar contract on v1')
})
