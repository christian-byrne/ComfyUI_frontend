...
describe('BC.07 — Connection observation, intercept, and veto [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N3', 0) and run against runV2().
  it.todo('S2.N3 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N12', 0) and run against runV2().
  it.todo('S2.N12 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N13', 0) and run against runV2().
  it.todo('S2.N13 — exemplar contract on v2')
})
