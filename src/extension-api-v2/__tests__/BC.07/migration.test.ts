...
describe('BC.07 — Connection observation, intercept, and veto [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N3', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N3 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N12', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N12 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N13', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N13 — migrates from v1 to v2')
})
