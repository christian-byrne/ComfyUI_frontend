...
describe('BC.17 — Backend execution lifecycle and progress events [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S5.A1', 0) and run against runV1().
  it.todo('S5.A1 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S5.A2', 0) and run against runV1().
  it.todo('S5.A2 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S5.A3', 0) and run against runV1().
  it.todo('S5.A3 — exemplar contract on v1')
})
