...
describe('BC.22 — Context menu contributions (node and canvas) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N5', 0) and run against runV1().
  it.todo('S2.N5 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H3', 0) and run against runV1().
  it.todo('S1.H3 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H4', 0) and run against runV1().
  it.todo('S1.H4 — exemplar contract on v1')
})
