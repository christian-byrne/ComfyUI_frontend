...
describe('BC.22 — Context menu contributions (node and canvas) [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N5', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N5 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H3', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S1.H3 — migrates from v1 to v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S1.H4', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S1.H4 — migrates from v1 to v2')
})
