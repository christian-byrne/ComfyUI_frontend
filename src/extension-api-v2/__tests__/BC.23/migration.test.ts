...
describe('BC.23 — Node property bag mutations [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N18', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N18 — migrates from v1 to v2')
})
