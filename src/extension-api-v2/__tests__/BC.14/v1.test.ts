...
describe('BC.14 — Workflow → API serialization interception (graphToPrompt) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A1', 0) and run against runV1().
  it.todo('S6.A1 — exemplar contract on v1')
})
