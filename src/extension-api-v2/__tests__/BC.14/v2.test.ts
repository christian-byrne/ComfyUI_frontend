...
describe('BC.14 — Workflow → API serialization interception (graphToPrompt) [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A1', 0) and run against runV2().
  it.todo('S6.A1 — exemplar contract on v2')
})
