...
describe('BC.28 — Subgraph fan-out via set/get virtual nodes [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.SG1', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S9.SG1 — migrates from v1 to v2')
})
