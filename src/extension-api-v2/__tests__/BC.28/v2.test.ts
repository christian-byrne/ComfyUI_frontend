...
describe('BC.28 — Subgraph fan-out via set/get virtual nodes [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.SG1', 0) and run against runV2().
  it.todo('S9.SG1 — exemplar contract on v2')
})
