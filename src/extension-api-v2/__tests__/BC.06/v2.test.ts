...
describe('BC.06 — Custom canvas drawing (per-node and canvas-level) [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N9', 0) and run against runV2().
  it.todo('S2.N9 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S3.C1', 0) and run against runV2().
  it.todo('S3.C1 — exemplar contract on v2')
})
