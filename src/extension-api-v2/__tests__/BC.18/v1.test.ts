...
describe('BC.18 — Backend HTTP calls [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S6.A3', 0) and run against runV1().
  it.todo('S6.A3 — exemplar contract on v1')
})
