...
describe('BC.02 — Node lifecycle: teardown [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N4', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S2.N4 — migrates from v1 to v2')
})
