...
describe('BC.02 — Node lifecycle: teardown [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N4', 0) and run against runV1().
  it.todo('S2.N4 — exemplar contract on v1')
})
