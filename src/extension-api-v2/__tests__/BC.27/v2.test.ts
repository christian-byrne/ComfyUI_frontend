...
describe('BC.27 — LiteGraph entity direct manipulation (reroute, group, link, slot) [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.R1', 0) and run against runV2().
  it.todo('S9.R1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.G1', 0) and run against runV2().
  it.todo('S9.G1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.L1', 0) and run against runV2().
  it.todo('S9.L1 — exemplar contract on v2')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.S1', 0) and run against runV2().
  it.todo('S9.S1 — exemplar contract on v2')
})
