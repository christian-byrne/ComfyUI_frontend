...
describe('BC.27 — LiteGraph entity direct manipulation (reroute, group, link, slot) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.R1', 0) and run against runV1().
  it.todo('S9.R1 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.G1', 0) and run against runV1().
  it.todo('S9.G1 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.L1', 0) and run against runV1().
  it.todo('S9.L1 — exemplar contract on v1')

  // TODO(I-TF): hydrate via loadEvidenceSnippet('S9.S1', 0) and run against runV1().
  it.todo('S9.S1 — exemplar contract on v1')
})
