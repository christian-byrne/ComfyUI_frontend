...
describe('BC.25 — Shell UI registration (commands, sidebars, toasts) [v2 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S12.UI1', 0) and run against runV2().
  it.todo('S12.UI1 — exemplar contract on v2')
})
