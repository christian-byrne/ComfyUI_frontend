...
describe('BC.08 — Programmatic linking [v1 → v2 migration]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S10.D2', 0) and run against runV1 + runV2 (assert behavioral parity).
  it.todo('S10.D2 — migrates from v1 to v2')
})
