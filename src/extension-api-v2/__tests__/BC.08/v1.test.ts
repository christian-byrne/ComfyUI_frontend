...
describe('BC.08 — Programmatic linking [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S10.D2', 0) and run against runV1().
  it.todo('S10.D2 — exemplar contract on v1')
})
