...
describe('BC.16 — Execution output consumption (per-node) [v1 contract]', () => {
  // TODO(I-TF): hydrate via loadEvidenceSnippet('S2.N2', 0) and run against runV1().
  it.todo('S2.N2 — exemplar contract on v1')
})
